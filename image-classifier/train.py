...
model, optimizer, criterion = network.nn_network(structure,dropout,hidden_layer1,lr,power)


network.train_network(model, optimizer, criterion, trainloader, v_loader, epochs, 20, power)


network.save_checkpoint(model,train_data,path,structure,hidden_layer1,dropout,lr)
