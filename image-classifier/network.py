...
def load_data(flower_dir  = "./flowers" ):
    '''
    ...
    '''
    train_dir = flower_dir + '/train'
    valid_dir = flower_dir + '/valid'
    test_dir = flower_dir + '/test'
...
def train_network(model, criterion, optimizer, loader, vloader, epochs = 3, print_every=20,power='gpu'):
    '''
...
def load_checkpoint(path='checkpoint.pth'):
    ...
    model,_,_ = nn_network(structure,dropout,hidden_layer1,lr)
